"""Function-calling answering loop that lets the model choose retrieval operations."""
...
class FunctionCallingAnsweringAgent:
    """Run a multi-turn function-calling loop for retrieval-backed answers."""
    ...
    def __init__(
        ...
        *,
        settings: Settings,
        client: AsyncOpenAI,
        structure_parser: QuestionStructureParser,
    ) -> None:
